...
public class PartidaDao {
    ...
    public boolean registrar(Partida p) {
        ...
        try {
            ...
            ps.execute();
            System.out.println("Partida guardada en los libros digitales.");
            return true;
    ...
    public List<Partida> listarTodo() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                p.setId(rs.getInt("id_partida")); // Se deja solo el nombre real de la columna
    ...
    // Método breve para no repetir código de cierre
